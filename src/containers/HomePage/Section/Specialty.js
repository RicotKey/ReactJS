            ...
            <div className='section-share section-specialty'>
                <div className='section-container'>
                    <div className='section-header'>
                        <span className='title-section'><FormattedMessage id='homepage.specialty-popluar' /></span>
                        ...
                        <Slider {...this.props.settings}>
                            {dataSpecialty && dataSpecialty.length > 0 && dataSpecialty.map((item, index) => {
                                return (
                                    ...
                                    >
                                        <div className='bg-image section-sepcialty' style={{ backgroundImage: `url(${this.convertBase64toString(item.image)})` }}>
